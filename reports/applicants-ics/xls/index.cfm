...
<cfif #cgi.query_string# NEQ ''>
    <cfif #cgi.query_string# CONTAINS 'date='>
     ...
     <cfelseif #fa# EQ 'PNW'>
        <cfset dateq = createdate(2017,09,30)>
     <cfelseif #fa# EQ 'Southwest'>
        <cfset dateq = createdate(2017,11,01)>
     <cfelseif #fa# EQ 'Great Basin'>
        <cfset dateq = createdate(2017,11,27)>
     <cfelse>
...
<cfif #cgi.query_string# NEQ '' and  #areaq# EQ '' and #teamq# EQ '' and #positionq# EQ '' and #userq# EQ '' and #posidq# EQ '' and #dateq# EQ ''>
 ...
 <cfelse>
    ...
    and p.position_code in ('IC','ICT1','ICT2')
...
<cfheader name="Content-Disposition" value="attachment; filename=applicants-ics-#fa#-#dateformat(today,'yyyy-mm-dd')#.xls">
