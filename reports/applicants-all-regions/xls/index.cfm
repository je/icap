 ...
 <cfelse>
    ...
    <cfif #areaq# NEQ '' and #positionq# NEQ ''>
     ...
     <cfelseif  #positionq# NEQ ''>
        and p.position_code = '#positionq#'
     <cfelseif  #userq# NEQ ''>
        and a.applicant_eauth_id = '#userq#'
     <cfelseif  #posidq# NEQ ''>
        and p.position_id = '#posidq#'
     <cfelseif #session.q# NEQ ''>
        and p.position_code like '%#session.q#%'
    </cfif>
    <cfif #dateq# NEQ ''>
